...
/*  map1.insert_element("Himanshu");
  ...
  map1.increase_count("Himanshu", 200000000000000);
  map1.decrease_count("Himanshu", 11122);
  print_map();
...
// Test case: 4 - Testing the search function
/* map1.insert_element(1);
  map1.increase_count(1, 100000000);
  map1.decrease_count(1, 900000);
  console.log(map1.count(1));
  console.log(map1.search(1).found);
  console.log(map1.search(2).found);
*/

// Test case: 5 - Testing decrease count and remove_element functions
